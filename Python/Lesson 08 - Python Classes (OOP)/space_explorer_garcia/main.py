...
# I fully would not have known where to start when it comes to making a main.py to wrap the whole game together without scaffolding or more detailed instructions
...
def clear_screen() -> None:                             # What even is this? How would I have known to make this?
...
# Trial and error modifying the danger attribute of Planets

# Implement a config file or data file to dynamically store/load data
# This is not something we have learned or even talked about at all yet??