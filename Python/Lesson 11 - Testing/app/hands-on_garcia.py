# Hands-On (In-Class) 20260805

# Note that instead of modifying test_book.py, I have its code here and then add onto it within my own filename

# Original code from test_book.py
import pytest
...
# Exercise 2
    def test_isbn_length():
        """Check 10 and 13 Digit ISBNs"""
        assert validate_isbn('1234567890') == True
        assert validate_isbn('1234567890123') == True

    def test_isbn_punctuation():
        """Check ISBNs with hyphens and spaces are valid"""
        assert validate_isbn('123-456-789-0') == True
        assert validate_isbn('123 456 789 0') == True

    def test_isbn_invalid_formats():
        """Too short, too long, letters, and non-strings are invalid"""
...
### Never mind, these are being re-worked as of 20260805
